         ...
         <section class="mentor">
            <div class="container">
               ...
               <div class="mentor_main">
                  <div id="teamcrousel" class="carousel slide" data-ride="carousel" data-interval='false'>
                     <div class="carousel-inner">
                        <div class="carousel-item active">
               ...
               <div class="bottom_bar">
                  ...
                  <div class="bottom_bar--right">
                     ...
                     <div class="left left_move" id="teamPre">
                        <img src="../icons/left-arr.svg" alt="">
                     </div>
                     <div class="right right_move" id="teamNext">
                        <img src="../icons/right-arr.svg" alt="">
                     </div>
                  </div>
               </div>
